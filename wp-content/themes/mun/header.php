                        ...
                        <div class="container">
                            <div class="d-flex align-items-center justify-content-between">
								...
								<div class="download-app">
									<ul>
										<li class="playstore-icon"><a href="https://play.google.com/store/apps/details?id=com.missuniversenepal"><img src="<?php echo get_template_directory_uri();?>/assets/img/icons/playstore.png" alt=""></a></li>
										<li class="appstore-icon"><a href="https://apps.apple.com/us/app/id1534669834"><img src="<?php echo get_template_directory_uri();?>/assets/img/icons/appstore.png" alt=""></a></li>
									</ul>
								</div>
