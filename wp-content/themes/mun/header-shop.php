        ...
        <header class="mun-header mun-header--fullscreen">
            <div class="mun-navbar mun-navbar--main mun-navbar--transparent mun-navbar--sticky mun-navbar--white-text-on-top">
                                ...
                                <div class="d-flex align-items-center justify-content-center h-100 shop_headMenu">
                                    <ul>
                                        ...
                                        if ( is_user_logged_in() ) {
                                            $logged_in = true;
                                        echo 'Hi, <a href="'.site_url('/my-account').'">'.ucfirst($current_user->user_login).'</a>!';
                                        } else {
                                        echo '<a href="'.site_url('/my-account').'">Login</a>';
                                        }
                                        ?>
                                        </li>
										<li>
             ...
             <!--                                   <a href="cart.php"><i class="icon-shopping-bag"></i>-->
													<!--<span class="item_count pkrs">2</span></a>-->
													<?php 
											if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
                                        $count = WC()->cart->cart_contents_count;
											?>
										
                                                <a class="choose_my_cart" href="<?php echo WC()->cart->get_cart_url(); ?>"> <i class="icon-shopping-bag" > </i> 
												<?php
                                        if ( $count > 0 ) {
